...
<template>
    <div class="h-screen flex w-full bg-img">
        <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
            ...
            <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse">Không tìm thấy thông tin/trang web yêu cầu.</p>
            <a href="/"> <vs-button size="large" >Quay về trang chủ</vs-button></a>
        </div>
    </div>
</template>
